    ...
    <div className="page active" style={{ animation: 'pgIn .2s ease both' }}>
      ...
      {importModal && (
        <div className="modal-bg open" onClick={e => { if (e.target === e.currentTarget) { setImportModal(false); setCsvPreview([]) } }}>
          <div className="modal-form-card" style={{ width: '100%', maxWidth: 600, background: 'var(--surface)', display: 'flex', flexDirection: 'column', overflow: 'visible', maxHeight: 'none', height: 'auto' }} onClick={e => e.stopPropagation()}>
            {/* Header */}
            ...
            {/* Body — flujo natural, sin scroll interno (el modal entra completo) */}
