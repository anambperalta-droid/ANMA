...
const DEFAULT_TEMPLATES = [
  ...
  { stage: 'Logística', title: 'Seguimiento con urgencia', isDefault: true,
    text: 'Hola {{nombre}}!\n\nLos tiempos de producción están corriendo y quería confirmar si avanzamos con el pedido de {{empresa}}.\n\nPara llegar a la fecha que necesitás, lo ideal es confirmar esta semana. ¿Qué te parece?' },
  { stage: 'Post-Venta', title: 'Agradecimiento post-entrega', isDefault: true,
    text: 'Hola {{nombre}}! 🙌\n\nEsperamos que los regalos hayan sido un éxito en {{empresa}}.\n\n¿Nos contás cómo les fue? Tu feedback nos ayuda a mejorar.\n\nPara futuros pedidos, ya tenemos tu perfil guardado. ¡Gracias!' },
