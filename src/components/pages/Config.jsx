        ...
        <div style={{ maxWidth: 1100 }}>
          <div className="cfg-com-grid">
            ...
            {/* ══ COLUMNA 1 — Configuración general ══
                 ...
                 en 2 columnas incluso en mobile. Dropdowns largos (formato,
                 rubro, tipo venta) full width por su texto de opciones. */}
            <div className="card" style={{ marginBottom: 0 }}>
                ...
                {/* Fila 2: Formato de números — full width */}
                <div className="fg">
                ...
                {/* Fila 5: Rubro (full) — dropdown con texto largo */}
                <div className="fg">
                  <label>Rubro</label>
                ...
                {/* Fila 6: Tipo de venta (full) — dropdown con hint */}
                <div className="fg" style={{ marginBottom: 0 }}>
        ...
        <div style={{ display: 'grid', gap: 20, maxWidth: 700 }}>
          ...
          <div className="card">
            ...
            <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <p style={{ fontSize: 11, color: 'var(--txt3)', textAlign: 'center', marginTop: 4, marginBottom: 0, lineHeight: 1.5 }}>
                <i className="fa fa-circle-info" style={{ marginRight: 5, color: '#7C3AED' }} />
                ¿Querés descargar tu backup? Andá a <strong>Mi cuenta → Descargar mis datos</strong>
              </p>
              {snapshots.length > 0 && (
